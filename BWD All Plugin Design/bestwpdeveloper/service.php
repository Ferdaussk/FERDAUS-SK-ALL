            ...
            <div class="row h-100 align-items-center">
                <div class="col-xl-12">
                    <div class="service-main-content text-center">
                        <h1>Best Services of Best WP Developer</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters pt">
                <div class="col-xl-6 col-lg-6 col-md-6 ">
                    <div class="right-content">
                        ...
                        <a href="website-design.html" class="button">Read More</a>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/web-design.webp);"></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/website-development.webp);"></div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="right-content-two">
                        ...
                        <a href="website-development.html" class="button">Read More</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-three">
                        ...
                        <a href="wordpress.html" class="button">Read More</a>  
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-three">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/wordpress.webp);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-four">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/ecommerce.webp);"></div>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-four">
                        ...
                        <a href="ecommerce-development.html" class="button">Read More</a> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-five">
                        ...
                        <a href="shopify-development.html" class="button">Read More</a>  
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-five">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/shopify.webp);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-six">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/speed-optimization.webp);"></div>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-six">
                        ...
                        <a href="speed-optimization.html" class="button">Read More</a>  
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-seven">
                        ...
                        <a href="maintenance.html" class="button">Read More</a> 
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-seven">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/maintenance.webp);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-eight">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/apps-development.webp);"></div>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-eight">
                        ...
                        <a href="apps-development.html" class="button">Read More</a> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-nine">
                        ...
                        <a href="seo-service-agency.html" class="button">Read More</a> 
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-nine">
                       <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/seo.webp);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-ten">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/graphic_design.webp);"></div>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-ten">
                        ...
                        <a href="graphic-design.html" class="button">Read More</a> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-eleven">
                        ...
                        <a href="digital-marketing.html" class="button">Read More</a>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-eleven">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/digital_marketing.webp);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="left-content-twelve">
                        <div class="service-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/service/consultancy.webp);"></div>
                    </div>  
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="right-content-twelve">
                        <h2>Consultancy</h2>
                        <p>The most popular CMS in the world is WordPress. Its popularity is increasing day by day only for its user-friendly website. At present 38% of websites are built-in WordPress CMS…</p>
                        <a href="consultancy.html" class="button">Read More</a>
                    </div>
                </div>
            </div>
        </div>
