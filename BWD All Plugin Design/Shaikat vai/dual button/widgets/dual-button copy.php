...
class BWDDBDualButtons extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'bwddb_style_selection_leftt_rightt',
			[
		...
		$this->add_control(
			...
			[
				...
				// 'default' => 'style1',
				'options' => [
					'default' => esc_html__( 'Default', 'bwd-dual-buttons' ),
					'leftt' => esc_html__( 'Hide L', 'bwd-dual-buttons' ),
					'rightt' => esc_html__( 'Hide R', 'bwd-dual-buttons' ),
				],
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				...
				'tab' => Controls_Manager::TAB_CONTENT,
				'conditions' => [
					'bwddb_style_selection_leftt_rightt' => 'leftt',
				],
			],
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				...
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'bwddb_style_selection_leftt_rightt' => ['style10', 'style11', 'style12', 'style13', 'style14', 'style15', 'style16', 'style17'],
				]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'condition' => [
					'bwddb_style_selection_leftt_rightt' => 'style12',
				],
				'label_on' => esc_html__( 'Show', 'bwd-dual-buttons' ),
				'label_off' => esc_html__( 'Hide', 'bwd-dual-buttons' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		if('style1' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		<div class="bwddb-btn <?php if('bwddb-left' === $settings['bwddb_first_alignment_buttons']){ ?> bwddb-btn-left <?php } elseif('bwddb-center' === $settings['bwddb_first_alignment_buttons']){ ?> bwddb-btn-center <?php } elseif('bwddb-right' === $settings['bwddb_first_alignment_buttons']){ ?> bwddb-btn-right <?php } ?> bwddb-1">
			<?php
			if('rightt' === $settings['bwddb_show_buttons_switcher']){
			?>
			...
			<?php
			} elseif('leftt' === $settings['bwddb_show_buttons_switcher']){
			?>
		...
		<?php
		} elseif('style2' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style3' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style4' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style5' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style6' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style7' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style8' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style9' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style10' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style11' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style12' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style13' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style14' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style15' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style16' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style17' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style18' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style19' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style20' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style21' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style22' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style23' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style24' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style25' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style26' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style27' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style28' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style29' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style30' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style31' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
		...
		<?php
		} elseif('style32' === $settings['bwddb_style_selection_leftt_rightt']){
		?>
	...
	protected function content_template() {
		...
		<div class="bwddb-btn <# if('bwddb-left' === settings['bwddb_first_alignment_buttons']){ #> bwddb-btn-left <# } else if('bwddb-center' === settings['bwddb_first_alignment_buttons']){ #> bwddb-btn-center <# } else if('bwddb-right' === settings['bwddb_first_alignment_buttons']){ #> bwddb-btn-right <# } #> bwddb-1">
			...
			<# } else if('leftt' === settings['bwddb_show_buttons_switcher']){ #>
		...
		<# } else if('style2' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style3' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style4' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style5' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style6' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style7' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style8' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style9' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style10' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style11' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style12' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style13' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style14' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style15' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style16' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style17' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style18' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style19' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style20' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style21' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style22' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style23' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style24' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style25' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style26' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style27' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style28' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style29' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style30' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style31' === settings['bwddb_style_selection_leftt_rightt']){ #>
		...
		<# } else if('style32' === settings['bwddb_style_selection_leftt_rightt']){ #>
