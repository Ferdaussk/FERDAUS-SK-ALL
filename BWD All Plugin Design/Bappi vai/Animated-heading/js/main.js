...
function splitAnimatingText(headingInner) {
...
function textAnimation(heading) {
  ...
  setTimeout(()=>{  headingWrapper.classList.remove("active")},time)
...
splitAnimatingText(headingInner1Inner);
...
function typing() {
  ...
  setTimeout(()=> {typing(heading)}, time);
}
...
// heading 16========================
let headingInner16Inner = selector(".bwd-animated-heading-16 .bwd-heading-inner");
splitAnimatingText(headingInner16Inner);

// heading 17========================
let headingInner17Inner = selector(".bwd-animated-heading-17 .bwd-heading-inner");
splitAnimatingText(headingInner17Inner);

// heading 18========================
let headingInner18Inner = selector(".bwd-animated-heading-18 .bwd-heading-inner");
splitAnimatingText(headingInner18Inner);

// heading 19========================
let headingInner19Inner = selector(".bwd-animated-heading-19 .bwd-heading-inner");
splitAnimatingText(headingInner19Inner);

// heading 20========================
let headingInner20Inner = selector(".bwd-animated-heading-20 .bwd-heading-inner");
splitAnimatingText(headingInner20Inner);

// heading 21========================
let headingInner21Inner = selector(".bwd-animated-heading-21 .bwd-heading-inner");
splitAnimatingText(headingInner21Inner);

// heading 22========================
let headingInner22Inner = selector(".bwd-animated-heading-22 .bwd-heading-inner");
splitAnimatingText(headingInner22Inner);

// heading 23========================
let headingInner23Inner = selector(".bwd-animated-heading-23 .bwd-heading-inner");
splitAnimatingText(headingInner23Inner);

// heading 24========================
let headingInner24Inner = selector(".bwd-animated-heading-24 .bwd-heading-inner");
...
// heading 26========================
let headingInner26Inner = selector(".bwd-animated-heading-26 .bwd-heading-inner");
splitAnimatingText(headingInner26Inner);


// heading 27========================
let headingInner27Inner = selector(".bwd-animated-heading-27 .bwd-heading-inner");
