...
const compareItem5 = document.querySelector(".bwdic-compare-item-5 .bwdic-compare-img-wrapper");
...
const compareItem6 = document.querySelector(".bwdic-compare-item-6 .bwdic-compare-img-wrapper");
