...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'videor-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'videor-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'videor-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'videor-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'videor-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'videor-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'videor-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'videor-elementor' ),
			'language'              => esc_html__( 'Language', 'videor-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'videor-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'videor-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'videor-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'videor-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'videor-elementor' ) : esc_html__( 'No', 'videor-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'videor-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'videor-elementor' ) : esc_html__( 'Inactive', 'videor-elementor' )
		];
