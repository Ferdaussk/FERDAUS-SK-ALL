...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpVideorElementor = window.mdpVideorElementor;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpVideorElementor.restBase }videor-elementor/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_videor_elementor',
                nonce: mdpVideorElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpVideorElementor.ajaxURL, data, function( response ) {
