...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'videor-elementor' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'videor-elementor', false, Plugin::get_path() . '/languages/' );
