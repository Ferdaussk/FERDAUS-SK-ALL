...
final class TabAssignments extends Tab  {
	...
	public function add_admin_scripts() {
        ...
        wp_enqueue_script( 'mdp-videor-elementor-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [ 'jquery-datetimepicker-full', 'jquery' ], Plugin::get_version(), true );
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_videor_elementor_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin <?php $this->is_need_to_hide( 'matching_method' ); ?>">
                    <h4><?php esc_html_e( 'Matching Method', 'videor-elementor' ); ?></h4>
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'videor-elementor' ); ?></p>
                    <div class="mdp-button-group mdp-button-group mdp-matchingMethod" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-all mdp-active"><?php esc_html_e( 'ALL', 'videor-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-any"><?php esc_html_e( 'ANY', 'videor-elementor' ); ?></button>
                    </div>
	                <p><?php esc_html_e('The plugin is enabled on the page if ALL the selected rules matched, or if ANY of the selected rules matched', 'videor-elementor' ); ?></p>
                </div>

                <div class="mdp-panel mdp-panel-box mdp-wp-content mdp-margin <?php $this->is_need_to_hide( 'wordpress_content' ); ?>">

                    <h4><?php esc_html_e( 'WordPress Content', 'videor-elementor' ); ?></h4>

                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'videor-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'videor-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'videor-elementor' ); ?></button>
                    </div>

                    <div class="mdp-wp-content-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Select on what page types or categories the assignment should be active.', 'videor-elementor' ); ?>
                        </p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-home-page mdp-margin <?php $this->is_need_to_hide( 'home_page' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Home Page', 'videor-elementor' ); ?></h4>
                ...
                <div class="mdp-panel mdp-panel-box mdp-menu-items mdp-margin <?php $this->is_need_to_hide( 'menu_items' ); ?>">
                    <h4><?php esc_html_e( 'Menu Items', 'videor-elementor' ); ?></h4>
                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'videor-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'videor-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'videor-elementor' ); ?></button>
                    ...
                    <div class="mdp-menuitems-selection">
                        <p class="mdp-margin-bottom-remove mdp-margin-top"><?php esc_html_e( 'Select the menu items to assign to.', 'videor-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin <?php $this->is_need_to_hide( 'date_time' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Date & Time', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-period-picker-box">
                        ...
                        <p>
							<?php esc_html_e( 'The date and time assignments use the date/time of your servers, not that of the visitors system.', 'videor-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'Current date/time:', 'videor-elementor' ); ?>
                ...
                <div class="mdp-panel mdp-panel-box mdp-languages mdp-margin <?php $this->is_need_to_hide( 'languages' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Languages', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="languages-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the languages to assign to.', 'videor-elementor' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-user-roles mdp-margin <?php $this->is_need_to_hide( 'user_roles' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'User Roles', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="user-roles-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the user roles to assign to.', 'videor-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-url mdp-margin <?php $this->is_need_to_hide( 'url' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'URL', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-url-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter (part of) the URLs to match.', 'videor-elementor' ); ?><br>
							<?php esc_html_e( 'Use a new line for each different match.', 'videor-elementor' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-devices mdp-margin <?php $this->is_need_to_hide( 'devices' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Devices', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-devices-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the devices to assign to. Keep in mind that device detection is not always 100% accurate. Users can setup their device to mimic other devices.', 'videor-elementor' ); ?></p>
                        <label>
                        <select class="devices chosen-select" multiple="">
                            <option value=""></option>
                            <option value="desktop"><?php esc_html_e( 'Desktop', 'videor-elementor' ); ?></option>
                            <option value="tablet"><?php esc_html_e( 'Tablet', 'videor-elementor' ); ?></option>
                            <option value="mobile"><?php esc_html_e( 'Mobile', 'videor-elementor' ); ?></option>
                        </select>
                        </label>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Operating Systems', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-os-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the operating systems to assign to. Keep in mind that operating system detection is not always 100% accurate. Users can setup their browser to mimic other operating systems.', 'videor-elementor' ); ?></p>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php esc_html_e( 'Windows (All)', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 10.0"><?php esc_html_e( 'Windows 10', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 6.2"><?php esc_html_e( 'Windows 8', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 6.1"><?php esc_html_e( 'Windows 7', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 6.0"><?php esc_html_e( 'Windows Vista', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 5.2"><?php esc_html_e( 'Windows Server 2003', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 5.1"><?php esc_html_e( 'Windows XP', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 5.01"><?php esc_html_e( 'Windows 2000 sp1', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 5.0"><?php esc_html_e( 'Windows 2000', 'videor-elementor' ); ?></option>
                            <option value="Windows nt 4.0"><?php esc_html_e( 'Windows NT 4.0', 'videor-elementor' ); ?></option>
                            <option value="Win 9x 4.9"><?php esc_html_e( 'Windows Me', 'videor-elementor' ); ?></option>
                            <option value="Windows 98"><?php esc_html_e( 'Windows 98', 'videor-elementor' ); ?></option>
                            <option value="Windows 95"><?php esc_html_e( 'Windows 95', 'videor-elementor' ); ?></option>
                            <option value="Windows ce"><?php esc_html_e( 'Windows CE', 'videor-elementor' ); ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (All)', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X"><?php esc_html_e( 'Mac OSX (All)', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.11"><?php esc_html_e( 'Mac OSX El Capitan', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.10"><?php esc_html_e( 'Mac OSX Yosemite', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.9"><?php esc_html_e( 'Mac OSX Mavericks', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.8"><?php esc_html_e( 'Mac OSX Mountain Lion', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.7"><?php esc_html_e( 'Mac OSX Lion', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.6"><?php esc_html_e( 'Mac OSX Snow Leopard', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.5"><?php esc_html_e( 'Mac OSX Leopard', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.4"><?php esc_html_e( 'Mac OSX Tiger', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.3"><?php esc_html_e( 'Mac OSX Panther', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.2"><?php esc_html_e( 'Mac OSX Jaguar', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.1"><?php esc_html_e( 'Mac OSX Puma', 'videor-elementor' ); ?></option>
                            <option value="Mac OS X 10.0"><?php esc_html_e( 'Mac OSX Cheetah', 'videor-elementor' ); ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (classic)', 'videor-elementor' ); ?></option>
                            <option value="#(Linux|X11)#"><?php esc_html_e( 'Linux', 'videor-elementor' ); ?></option>
                            <option value="OpenBSD"><?php esc_html_e( 'Open BSD', 'videor-elementor' ); ?></option>
                            <option value="SunOS"><?php esc_html_e( 'Sun OS', 'videor-elementor' ); ?></option>
                            <option value="QNX"><?php esc_html_e( 'QNX', 'videor-elementor' ); ?></option>
                            <option value="BeOS"><?php esc_html_e( 'BeOS', 'videor-elementor' ); ?></option>
                            <option value="OS/2"><?php esc_html_e( 'OS/2', 'videor-elementor' ); ?></option>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-browsers mdp-margin <?php $this->is_need_to_hide( 'browsers' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Browsers', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-browsers-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the browsers to assign to. Keep in mind that browser detection is not always 100% accurate. Users can setup their browser to mimic other browsers.', 'videor-elementor' ); ?></p>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Browsers:', 'videor-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php esc_html_e( 'Chrome (All)', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(6[1-9]|70)\.#"><?php esc_html_e( 'Chrome 61-70', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(5[1-9]|60)\.#"><?php esc_html_e( 'Chrome 51-60', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(4[1-9]|50)\.#"><?php esc_html_e( 'Chrome 41-50', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(3[1-9]|40)\.#"><?php esc_html_e( 'Chrome 31-40', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(2[1-9]|30)\.#"><?php esc_html_e( 'Chrome 21-30', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/(1[1-9]|20)\.#"><?php esc_html_e( 'Chrome 11-20', 'videor-elementor' ); ?></option>
                                    <option value="#Chrome/([1-9]|10)\.#"><?php esc_html_e( 'Chrome 1-10', 'videor-elementor' ); ?></option>
                                    <option value="Firefox"><?php esc_html_e( 'Firefox (All)', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(6[1-9]|70)\.#"><?php esc_html_e( 'Firefox 61-70', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(5[1-9]|60)\.#"><?php esc_html_e( 'Firefox 51-60', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(4[1-9]|50)\.#"><?php esc_html_e( 'Firefox 41-50', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(3[1-9]|40)\.#"><?php esc_html_e( 'Firefox 31-40', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(2[1-9]|30)\.#"><?php esc_html_e( 'Firefox 21-30', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/(1[1-9]|20)\.#"><?php esc_html_e( 'Firefox 11-20', 'videor-elementor' ); ?></option>
                                    <option value="#Firefox/([1-9]|10)\.#"><?php esc_html_e( 'Firefox 1-10', 'videor-elementor' ); ?></option>
                                    <option value="MSIE"><?php esc_html_e( 'Internet Explorer (All)', 'videor-elementor' ); ?></option>
                                    <option value="MSIE Edge"><?php esc_html_e( 'Internet Explorer Edge', 'videor-elementor' ); ?></option>
                                    <option value="Edge/15"><?php esc_html_e( 'Edge 15', 'videor-elementor' ); ?></option>
                                    <option value="Edge/14"><?php esc_html_e( 'Edge 14', 'videor-elementor' ); ?></option>
                                    <option value="Edge/13"><?php esc_html_e( 'Edge 13', 'videor-elementor' ); ?></option>
                                    <option value="Edge/12"><?php esc_html_e( 'Edge 12', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 11"><?php esc_html_e( 'Internet Explorer 11', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 10.6"><?php esc_html_e( 'Internet Explorer 10.6', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 10.0"><?php esc_html_e( 'Internet Explorer 10.0', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 10."><?php esc_html_e( 'Internet Explorer 10', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 9."><?php esc_html_e( 'Internet Explorer 9', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 8."><?php esc_html_e( 'Internet Explorer 8', 'videor-elementor' ); ?></option>
                                    <option value="MSIE 7."><?php esc_html_e( 'Internet Explorer 7', 'videor-elementor' ); ?></option>
                                    <option value="#MSIE [1-6]\.#"><?php esc_html_e( 'Internet Explorer 1-6', 'videor-elementor' ); ?></option>
                                    <option value="Opera"><?php esc_html_e( 'Opera (All)', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/(5[1-9]|60)\.#"><?php esc_html_e( 'Opera 51-60', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/(4[1-9]|50)\.#"><?php esc_html_e( 'Opera 41-50', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/(3[1-9]|40)\.#"><?php esc_html_e( 'Opera 31-40', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/(2[1-9]|30)\.#"><?php esc_html_e( 'Opera 21-30', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/(1[1-9]|20)\.#"><?php esc_html_e( 'Opera 11-20', 'videor-elementor' ); ?></option>
                                    <option value="#Opera/([1-9]|10)\.#"><?php esc_html_e( 'Opera 1-10', 'videor-elementor' ); ?></option>
                                    <option value="Safari"><?php esc_html_e( 'Safari (All)', 'videor-elementor' ); ?></option>
                                    <option value="#Version/11\..*Safari/#"><?php esc_html_e( 'Safari 11', 'videor-elementor' ); ?></option>
                                    <option value="#Version/10\..*Safari/#"><?php esc_html_e( 'Safari 10', 'videor-elementor' ); ?></option>
                                    <option value="#Version/9\..*Safari/#"><?php esc_html_e( 'Safari 9', 'videor-elementor' ); ?></option>
                                    <option value="#Version/8\..*Safari/#"><?php esc_html_e( 'Safari 8', 'videor-elementor' ); ?></option>
                                    <option value="#Version/7\..*Safari/#"><?php esc_html_e( 'Safari 7', 'videor-elementor' ); ?></option>
                                    <option value="#Version/6\..*Safari/#"><?php esc_html_e( 'Safari 6', 'videor-elementor' ); ?></option>
                                    <option value="#Version/5\..*Safari/#"><?php esc_html_e( 'Safari 5', 'videor-elementor' ); ?></option>
                                    <option value="#Version/4\..*Safari/#"><?php esc_html_e( 'Safari 4', 'videor-elementor' ); ?></option>
                                    <option value="#Version/[1-3]\..*Safari/#"><?php esc_html_e( 'Safari 1-3', 'videor-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Mobile Browsers:', 'videor-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'videor-elementor' ); ?></option>
                                    <option value="Android"><?php esc_html_e( 'Android', 'videor-elementor' ); ?></option>
                                    <option value="#Android.*Chrome#"><?php esc_html_e( 'Android Chrome', 'videor-elementor' ); ?></option>
                                    <option value="Blackberry"><?php esc_html_e( 'Blackberry', 'videor-elementor' ); ?></option>
                                    <option value="IEMobile"><?php esc_html_e( 'IE Mobile', 'videor-elementor' ); ?></option>
                                    <option value="iPad"><?php esc_html_e( 'iPad', 'videor-elementor' ); ?></option>
                                    <option value="iPhone"><?php esc_html_e( 'iPhone', 'videor-elementor' ); ?></option>
                                    <option value="iPod"><?php esc_html_e( 'iPod Touch', 'videor-elementor' ); ?></option>
                                    <option value="NetFront"><?php esc_html_e( 'NetFront', 'videor-elementor' ); ?></option>
                                    <option value="NokiaBrowser"><?php esc_html_e( 'Nokia', 'videor-elementor' ); ?></option>
                                    <option value="Opera Mini"><?php esc_html_e( 'Opera Mini', 'videor-elementor' ); ?></option>
                                    <option value="Opera Mobi"><?php esc_html_e( 'Opera Mobile', 'videor-elementor' ); ?></option>
                                    <option value="UC Browser"><?php esc_html_e( 'UC Browser', 'videor-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'IP Addresses', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-ips-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
                            <?php esc_html_e( 'IP Addresses / Ranges', 'videor-elementor' ); ?><br>
                        </p>

                        <!--suppress HtmlFormInputWithoutLabel -->
                        <textarea class="mdp-ips-field"></textarea>
                        <p>
                            <?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'videor-elementor' ); ?><br>
                            <?php esc_html_e( '46.33.233.31', 'videor-elementor' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'videor-elementor' ); ?><br>
                            <?php esc_html_e( '46', 'videor-elementor' ); ?>
                        </p>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-php mdp-margin <?php $this->is_need_to_hide( 'custom_php' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Custom PHP', 'videor-elementor' ); ?></h4>
                    ...
                    <div class="mdp-php-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter a piece of PHP code to evaluate. The code must return the value true or false.', 'videor-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'For instance:', 'videor-elementor' ); ?>
                        </p>
