...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'VideorElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'VideorElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'VideorElementor' . $tab_slug . 'OptionsGroup', 'mdp_videor_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_videor_elementor_' . $tab_slug . '_page_status_section', '', null, 'VideorElementor' . $tab_slug . 'OptionsGroup' );
