 ...
 *
 * @wordpress-plugin
 * Plugin Name: Videor for Elementor
 * Plugin URI: https://1.envato.market/videor-elementor
 * Description: Videor masks YouTube & Vimeo videos by creative & extra-ordinary custom shapes.
 * Version: 1.1.1
...
use Merkulove\VideorElementor\Caster;
use Merkulove\VideorElementor\Config;
use Merkulove\VideorElementor\Unity\Unity;
 ...
 *
 **/
final class VideorElementor {

    /**
     * The one true VideorElementor.
     *
     * @var VideorElementor
     * @since 1.0.0
     * @access private
	...
	public static function on_activation() {
        ...
        /** Call Videor on plugin activation */
...
register_activation_hook( __FILE__, [ VideorElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ VideorElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ VideorElementor::get_instance(), 'setup' ] );
