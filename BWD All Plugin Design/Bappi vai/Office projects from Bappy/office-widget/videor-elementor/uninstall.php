...
use Merkulove\VideorElementor\Unity\Cache;
use Merkulove\VideorElementor\Unity\Helper;
use Merkulove\VideorElementor\Unity\Plugin;
use Merkulove\VideorElementor\UninstallHelper;
use Merkulove\VideorElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_videor_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_videor_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_videor_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
