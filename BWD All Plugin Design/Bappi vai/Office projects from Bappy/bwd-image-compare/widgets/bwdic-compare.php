...
class BWDMEcompare extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'bwdic_style_selection' => ['style5', 'style6'],
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'condition' => [
					'bwdic_style_selection' => ['style2', 'style4', 'style5', 'style6',]
				],
				'selectors' => [
	...
	protected function render() {
		...
		?>
		<div class="bwdic-compare-item bwdic-compare-item-6">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-text-before"><?php echo esc_html__($settings['bwdic_compare_the_before_text_fiix']); ?></div>
				<div class="bwdic-text-after"><?php echo esc_html__($settings['bwdic_compare_the_after_text_fiix']); ?></div>
				<div class="bwdic-compare-img">
    ...
    protected function content_template() {
		...
		<div class="bwdic-compare-item bwdic-compare-item-1">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-compare-img">
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
		...
		<# } else if('style2' === settings['bwdic_style_selection']){ #>
		<div class="bwdic-compare-item bwdic-compare-item-2">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-compare-img">
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
					<img src="{{{settings['bwdic_image_one']['url']}}}" alt="nature img" />
					<div
					class="bwdic-after"
					style="background-image: url({{{settings['bwdic_image_two']['url']}}})"
					></div>
					<div class="bwdic-slider-bar">
					<div class="bwdic-drag-line">
						<div class="bwdic-dragline-inner">
		...
		<# } else if('style3' === settings['bwdic_style_selection']){ #>
		<div class="bwdic-compare-item bwdic-compare-item-3">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-compare-img">
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
		...
		<# } else if('style4' === settings['bwdic_style_selection']){ #>
		<div class="bwdic-compare-item bwdic-compare-item-4">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-compare-img">
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
		...
		<# } else if('style5' === settings['bwdic_style_selection']){ #>
		<div class="bwdic-compare-item bwdic-compare-item-5">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-text-before">{{{settings['bwdic_compare_the_before_text_fiix']}}}</div>
				<div class="bwdic-text-after">{{{settings['bwdic_compare_the_after_text_fiix']}}}</div>
				<div class="bwdic-compare-img">
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
					<img src="{{{settings['bwdic_image_one']['url']}}}" alt="nature img" />
					<div
		...
		<# } else if('style6' === settings['bwdic_style_selection']){ #>
		<div class="bwdic-compare-item bwdic-compare-item-6">
			<div class="bwdic-compare-img-wrapper">
				<div class="bwdic-text-before">{{{settings['bwdic_compare_the_before_text_fiix']}}}</div>
				<div class="bwdic-text-after">{{{settings['bwdic_compare_the_after_text_fiix']}}}</div>
				...
				<div class="bwdic-before bwdic-common-class-px <# if('solid' === settings['bwdic_border_style']){ #> bwdic-common-class-style-solid <# } else if('dashed' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dashed <# } else if('dotted' === settings['bwdic_border_style']){ #> bwdic-common-class-style-dotted <# } else if('double' === settings['bwdic_border_style']){ #> bwdic-common-class-style-double <# } #> bwdic-common-class-color">
					<img src="{{{settings['bwdic_image_one']['url']}}}" alt=" img" />
					<div class="bwdic-after" style="background-image: url({{{settings['bwdic_image_two']['url']}}})"
					></div>
					<div class="bwdic-slider-bar">
					<div class="bwdic-drag-line">
						<div class="bwdic-dragline-inner"></div>
