...
function toolTip(brandLogoItem){
  
  const allItems = brandLogoItem.querySelectorAll('.bwdlc-brand-box-part');
...
let brandLogoItem = document.querySelector('.bwdlc-brand-logo-1');
toolTip(brandLogoItem);
