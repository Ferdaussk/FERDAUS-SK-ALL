...
function HTLMakerRoot(TL,TLItems,HrProgress){
    ...
    // let stickyScroll=() =>{
    //     window.onscroll = function () { window.scrollTo(0, 500); };
    // }
...
let myIntervalTest =()=>{
 ...
 TL2.addEventListener('mouseenter',function(e){
 
    let myInvlId= myIntervalTest();
...
const TL2= $('.bwd-timeline-two');
const TL3= $('.bwd-timeline-three');
...
function HTLMakerRoot(TL,TLItems,HrProgress){
   ...
   window.addEventListener('scroll', function() {
                ...
                console.log(`top desc${TLTopDsc} windowH2 ${windowH2} windowH3 ${windowH3}`)
...
function backupfun(id) {

    TL2.addEventListener('mouseleave',function(){
        clearInterval(id)
    })
