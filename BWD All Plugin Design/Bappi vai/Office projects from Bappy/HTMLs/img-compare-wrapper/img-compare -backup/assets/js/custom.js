...
// img compare 1==========================
const compareItem1 = document.querySelector(
  ".bwd-img-compare-1 .bwd-compare-item:nth-child(1)"
);

imgCompare(compareItem1, "input");


const compareItem2 = document.querySelector(
  ".bwd-img-compare-1 .bwd-compare-item:nth-child(2)"
);
imgCompare(compareItem2, "input");



const compareItem3 = document.querySelector(
  ".bwd-img-compare-1 .bwd-compare-item:nth-child(3)"
);
imgCompare(compareItem3, "input");



const compareItem4 = document.querySelector(
  ".bwd-img-compare-1 .bwd-compare-item:nth-child(4)"
);
...
const compareItem5 = document.querySelector(
  ".bwd-img-compare-2 .bwd-compare-item"
);
...
const compareItem6 = document.querySelector(
  ".bwd-img-compare-2 .bwd-compare-item:nth-child(2)"
);
