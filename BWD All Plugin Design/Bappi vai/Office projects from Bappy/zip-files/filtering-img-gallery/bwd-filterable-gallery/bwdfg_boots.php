...
class ClassBWDFGfilterable {
	...
	public function bwdfg_all_assets_for_the_public(){
		$all_css_js_file = array(
            ...
            'bwdfg_filterable_magnific_popup_css' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/magnific-popup.css'),
            ...
            'bwdfg_filterable_jquery_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/jquery-3.6.0.min.js'),
            'bwdfg_filterable_bootstrap_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/bootstrap.bundle.min.js'),
            'bwdfg_filterable_magnific_popup_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/jquery.magnific-popup.min.js'),
            'bwdfg_filterable_imagesloaded_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/imagesloaded.pkgd.min.js'),
            'bwdfg_filterable_snake_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/snake.js'),
            'bwdfg_filterable_isotope_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/isotope.pkgd.min.js'),
