...
function bwdtl_timeline_register_required_plugins() {
	...
	if (bwdtl_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Timeline</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Timeline</b> requires Elementor to be installed and activated.</p>';
...
function bwdtl_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Timeline</b> does not work since you are using an older version of Elementor</p>';
