...
class ClassBWDFGfilterable {
	...
	public function bwdfg_all_assets_for_the_public(){
		...
		$all_css_js_file = array(
			...
			'bwdfg_filterable_mgPopup_css' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/magnific-popup.css'),

            'bwdfg_filterable_style_css' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/style.css'),

			//js
			'bwdfg_filterable_jquery_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/jquery-3.6.1.min.js'),

            'bwdfg_filterable_bootstrap_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/bootstrap.bundle.min.js'),

			'bwdfg_filterable_mgPopup_js' => array('bwdfg_path_define'=>BWDFG_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/jquery.magnific-popup.min.js'),
