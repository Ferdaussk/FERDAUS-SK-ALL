...
function bwdlc_admin_notice_missing_main_plugin() {
	...
	if (bwdlc_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Brand Logo</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Brand Logo</b> requires Elementor to be installed and activated.</p>';
...
function bwdlc_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Brand Logo</b> does not work since you are using an older version of Elementor</p>';
