<div class="thf_header_common dates-header-3 <?php echo $thf_header_bg.' '.$thf_menu_indi_align.' '.$thf_menu_i_main .' '. $thf_menu_i_child .' '. $thf_header_style; ?>">
...
<!-- for mobile menu -->
<div class="off-canvas-dates-header-3 ocv-style-3 offcanvas-header-common <?php echo $thf_header_bg.' '.$thf_menu_indi_align.' '.$thf_menu_i_main .' '. $thf_menu_i_child .' '. $thf_header_style; ?>">
    <?php if('yes' === $thf_nav_logo_switcher){ ?>
    <div class="dates-header-logo <?php echo $thf_logo_align; ?>">
        <?php if('custom_link' === $thf_choose_logo_link){ ?><a href="<?php echo esc_url($settings['thf_logo_wraper_link']['url']); ?>"><?php } else{ ?>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
