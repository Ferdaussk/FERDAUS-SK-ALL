<div class="thf_header_common dates-header-7 <?php echo $thf_header_bg.' '.$thf_menu_indi_align.' '.$thf_menu_i_main .' '. $thf_menu_i_child .' '. $thf_header_style; ?>">
...
<!-- for mobile menu -->
<div class="off-canvas-dates-header-4 ocv-style-7 offcanvas-header-common <?php echo $thf_header_bg.' '.$thf_menu_indi_align.' '.$thf_menu_i_main .' '. $thf_menu_i_child .' '. $thf_header_style; ?>">
    <?php if('yes' === $thf_nav_logo_switcher){ ?>
    <div class="dates-header-logo <?php echo $thf_logo_align; ?>">
