...
function bwdcd_count_down_register_required_plugins() {
	...
	if (bwdcd_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Count Down</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Count Down</b> requires Elementor to be installed and activated.</p>';
...
function bwdcd_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Count Down</b> does not work since you are using an older version of Elementor</p>';
