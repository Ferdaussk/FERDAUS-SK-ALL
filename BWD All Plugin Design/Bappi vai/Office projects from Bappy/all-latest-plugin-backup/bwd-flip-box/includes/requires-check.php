...
function bwdff_flipflop_register_required_plugins() {
	...
	if (bwdff_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Flip Flop Box</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Flip Flop Box</b> requires Elementor to be installed and activated.</p>';
...
function bwdff_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Flip Flop Box</b> does not work since you are using an older version of Elementor</p>';
