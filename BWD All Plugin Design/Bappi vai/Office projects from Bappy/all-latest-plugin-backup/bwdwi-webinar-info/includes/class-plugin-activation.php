...
function bwdwi_webinar_info_register_required_plugins() {
	...
	if (bwdwi_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Webinar Info</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Webinar Info</b> requires Elementor to be installed and activated.</p>';
...
function bwdwi_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Webinar Info</b> does not work since you are using an older version of Elementor</p>';
