<?php
/**
 * Plugin Name: BWD Count Down
 * Description: BWD Count Down Elementor plugin with 30+ types of Count Down Effects.
 * Plugin URI:  https://www.bwdplugins.com/bwd-count-down/
 * Version:     1.0
...
final class FinalBWDCDCountDown{ 
	...
	public function bwdcd_init() {
		...
		if ( ! did_action( 'elementor/loaded' ) ) {
			...
			add_action( 'tgmpa_register', [$this, 'bwdcd_count_down_register_required_plugins'] );
			return;
		}
	...
	function bwdcd_count_down_register_required_plugins() {
		$plugins = array(
			array(
				'name'        => esc_html__('Elementor', 'bwdcd-count-down'),
				'slug'        => 'elementor',
	...
	public function bwdcd_admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'BWD Count Down', 'bwdcd-count-down' ) . '</strong>',
