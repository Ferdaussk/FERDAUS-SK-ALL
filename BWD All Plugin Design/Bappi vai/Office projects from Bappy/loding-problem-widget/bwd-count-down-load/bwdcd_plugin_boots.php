...
class ClassBWDCDCountDown {
	...
	public function bwdcd_all_assets_for_the_public(){
		$all_css_js_file = array(
            'bwdcd_count_down_all_main_css' => array('bwdcd_path_define'=>BWDCD_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/all.min.css'),

            'bwdcd_count_down_style_css' => array('bwdcd_path_define'=>BWDCD_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/style.css'),

            'bwdcd_count_down_bootstrap_css' => array('bwdcd_path_define'=>BWDCD_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/bs/bootstrap.min.css'),

            'bwdcd_count_down_custom_js' => array('bwdcd_path_define'=>BWDCD_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/custom.js'),

            'bwdcd_count_down_bootstrap_js' => array('bwdcd_path_define'=>BWDCD_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/bs/bootstrap.min.js'),
        );
        foreach($all_css_js_file as $handle => $fileinfo){
            wp_enqueue_style( $handle, $fileinfo['bwdcd_path_define'], null, '1.0', 'all');
            wp_enqueue_script( $handle, $fileinfo['bwdcd_path_define'], ['jquery'], '1.0', true);
        }
	}
