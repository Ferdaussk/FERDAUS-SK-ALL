...
function bwdbp_addon_failed_load() {
	...
	if (bwdbp_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Creative Blog Post</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Creative Blog Post</b> requires Elementor to be installed and activated.</p>';
...
function bwdbp_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Creative Blog Post</b> does not work since you are using an older version of Elementor</p>';
