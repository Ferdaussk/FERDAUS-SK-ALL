...
class ClassBWDTLTimelineBoots {
	...
	public function bwdtl_all_assets_for_the_public(){
		$all_css_js_file = array(
            'bwdtl_timeline_all_main_css' => array('bwdtl_path_define'=>BWDTL_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/all.min.css'),

            'bwdtl_timeline_style_css' => array('bwdtl_path_define'=>BWDTL_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/style.css'),

            'bwdtl_timeline_bootstrap_css' => array('bwdtl_path_define'=>BWDTL_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/css/bs/bootstrap.min.css'),

            'bwdtl_timeline_custom_js' => array('bwdtl_path_define'=>BWDTL_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/custom.js'),

            'bwdtl_timeline_bootstrap_js' => array('bwdtl_path_define'=>BWDTL_ASFSK_ASSETS_PUBLIC_DIR_FILE . '/js/bs/bootstrap.min.js'),
        );
