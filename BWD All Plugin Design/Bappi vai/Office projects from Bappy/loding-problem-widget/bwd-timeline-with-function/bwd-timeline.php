<?php
/**
 * Plugin Name: BWD Timeline
 * Description: BWD Timeline plugin with 23+ types of  Timeline Effects for Elementor.
 * Plugin URI:  https://bestwpdeveloper.com/plugins/elementor/bwd-timeline
 * Version:     1.0
...
final class Final_BWD_Timeline{ 
	...
	public function bwdtl_init() {
		...
		if ( ! did_action( 'elementor/loaded' ) ) {
			...
			add_action( 'tgmpa_register', [$this, 'bwdtl_timeline_register_required_plugins'] );
			return;
		}
	...
	function bwdtl_timeline_register_required_plugins() {
		$plugins = array(
			array(
				'name'        => esc_html__('Elementor', 'bwdtl-timeline'),
				'slug'        => 'elementor',
