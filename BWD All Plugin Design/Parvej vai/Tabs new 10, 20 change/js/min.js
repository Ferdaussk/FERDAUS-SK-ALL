...
// // tab two === === === === === === === ===
const tabTwoBtns = document.querySelectorAll('.bwdtz-tab-two .bwdtz-nav .bwdtz-tab-list');
...
// tab ten === === === === === === === ===
const tabTenBtns = document.querySelectorAll('.bwdtz-tab-ten .bwdtz-nav-tabs .bwdtz-tab-list');
...
const wheelNavItems = document.querySelectorAll('.bwdtz-tab-twenty .bwdtz-nav-tabs .bwdtz-tab-list button ');
...
// tab 20 === === === === === === === ===
const tab20Btns = document.querySelectorAll('.bwdtz-tab-twenty .bwdtz-nav-tabs .bwdtz-tab-list');
